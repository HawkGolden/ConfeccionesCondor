...
namespace Confecciones_Condor_1.Controllers
{
    public class AreasController : Controller
    {
        ...
        public AreasController(ConfeccionesCondorContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Areas != null ? 
                          ...
                          Problem("Entity set 'ConfeccionesCondorContext.Areas'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ConfeccionesCondorContext.Areas'  is null.");
            }
            var area = await _context.Areas.FindAsync(id);
            if (area != null)
            {
